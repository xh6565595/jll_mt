				...
				<block v-for="(item, index) in list" :key="index">
					<navigator :url="'/pages/main/details/details?code=' + item.project_code" class="hotItem">
						<view class="flex flex_center itemHeader">
							<image lazy-load="true" src="../../static/image/logo.png" mode="aspectFill"
								class="itemLogo animated fadeIn"></image>
						...
						<view class="picBox flex flex_around">
							<image v-if="item.project_img[0]" lazy-load="true" :src="item.project_img[0]"
								mode="aspectFill" class="left animated fadeIn"></image>
							<view class="f1">
