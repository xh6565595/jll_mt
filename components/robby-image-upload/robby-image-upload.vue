...
<script>
	export default {
		...
		props: ['value','enableDel','enableAdd','enableDrag','serverUrl','formData','header', 'limit','fileKeyName','serverUrlDeleteImage'],
		data() {
			return {
				imageBasePos:{
					x0: -1,
		...
		created: function(){
				// console.log(111)
			this.imageList = this.value?this.value:[]
									...
									uni.uploadFile({
										...
										success: function(res){
											if(res.statusCode === 200){
												...
												console.log('success to upload image: ' , Data)
												resolve(Data)
											}else{
